...
${ANTSPATH}${ANTSPATH:+/}antsRegistrationSyN.sh -d 3 -f ${Reference} -m ${WD}/xfms/${T1wRestoreBasename}2${StudyTemplateBasename}_Warped.nii.gz -x ${ReferenceMask},${T1wMask}.nii.gz -o ${WD}/xfms/T1w${StudyTemplateBasename}_to_MNI_
